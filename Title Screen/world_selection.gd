...
func _ready():
	...
	setup_world_tile(grasslands_tile, world_name, description, texture_path)
	...
	setup_world_tile(acacia_tile, world_name, description, texture_path)

	
func setup_world_tile(world_node, world_name, description, texture_path):
